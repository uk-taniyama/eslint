...
class RuleContext {
     ...
     * @param {boolean} fixable can fix or not..
     */
    constructor(ruleId, eslint, severity, options, settings, parserOptions, parserPath, meta, parserServices, fixable) {
    ...
    report(nodeOrDescriptor, location, message, opts) {
        ...
        if (arguments.length === 1) {
            ...
            if (this.fixable && typeof descriptor.fix === "function") {
