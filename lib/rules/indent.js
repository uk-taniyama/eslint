        ...
        function addElementListIndent(tokens, elements, offset) {
            ...
            */
            ...
            elements.forEach((element, index) => {
                ...
                if (offset === "first" && getFirstToken(elements[index]).loc.start.line !== getFirstToken(elements[0]).loc.start.line) {
        ...
        return {
            ...
            "Program:exit"() {
                ...
                sourceCode.ast.comments.forEach(comment => {
                    ...
                    if (getFirstTokenOfLine(comment) !== comment || validateTokenIndent(comment, getDesiredIndent(comment))) {
                        return;
                    }
