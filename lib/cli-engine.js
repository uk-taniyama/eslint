 ...
 * @property {string[]} fixSeverity Execute in autofix by severity.
 * @property {string[]} fixable Execute in autofix by fixable.
 ...
 *      should be allowed.
 * @prarm {Object} options.fix autofix configuration.
 ...
 * @param {Object} fix auto fix configration.
...
function CLIEngine(options) {
    ...
    if (this.options.fix) {
        ...
        // TODO function???
        this.options.fix = {};
        if (!this.options.fixSeverity) {
            this.options.fix.severity = { all: true };
        } else {
            this.options.fix.severity = this.options.fixSeverity.reduce((map, name) => {
                map[name] = true;
                return map;
            }, {});
        }
        if (!this.options.fixable) {
            this.options.fix.fixable = { all: true };
        } else {
            this.options.fix.fixable = this.options.fixable.reduce((map, name) => {
                map[name] = true;
                return map;
            }, {});
        }
